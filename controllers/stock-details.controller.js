...
module.exports.deleteStockDetails = (req, res) => {
    ...
    StockDetails.remove({ _id: req.params.id }).then(StockDetails => {
        res.send(StockDetails)
    }).catch(error => {
        res.send(error)
    })
...
module.exports.editStockDetails = (req, res) => {
    ...
    StockDetails.update({ _id: req.body.id }, { name: req.body.name }).then(StockDetails => {
        res.send(StockDetails)
    }).catch(error => {
        res.send(error)
    })
