...
//     Model.itemMod.findByIdAndUpdate({ _id: req.params.id }, req.body).then(function (ninja) {
...
//     Model.stocMod.findByIdAndUpdate({ _id: req.params.id }, req.body).then(function (ninja) {
